 ...
 *   the harness runtimes (`claude-code`, `copilot-cli`, #322) on a machine's daemon.
...
import { ANTHROPIC_API_PLUGIN_ID, CLAUDE_CODE_PLUGIN_ID, COPILOT_CLI_PLUGIN_ID, anthropicApiPlugin, claudeCodePlugin, copilotCliPlugin } from '@agentic/runtimes';
