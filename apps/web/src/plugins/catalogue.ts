...
import { anthropicApiRuntime, isolateMemoryImpl, memoryActorImpl } from '@agentic/platform';
...
/** The manifests the Registry lists for every workspace — enabled (the flat memory plugin and the A2A server excepted), with their declared scopes granted, until the owner changes them. */
