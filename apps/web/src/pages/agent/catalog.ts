 ...
 */
export const PLATFORM_TOOLS = ['memory_search', 'memory_remember', 'delegate', 'chat_post', 'chat_file_read', 'task_report', 'ask_user', 'usage_limits', 'projects', 'plan_list', 'plan_next', 'plan_claim', 'plan_assign', 'plan_update', 'plan_ref', 'plan_add', 'plan_handoff', 'requests_list', 'requests_triage', 'requests_resolve', 'projects_request', 'pull_report'] as const;
