        ...
        return (
            ...
            >
                <div data-env-fields>
                    ...
                    <NumberField model={() => d.concurrency} name="env-concurrency" label="Turns at once" description="How many agents may work in this environment at the same time; empty for no limit. With a limit, a message beyond it waits for a free slot. Open chats cost nothing until they work." min={1} step={1} placeholder="Unlimited" error={errorOf('concurrency')} disabled={props.busy} />
