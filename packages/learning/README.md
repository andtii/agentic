...
- **Repeats supersede** (LRN-06): a correction of the same kind with ≥ 0.6 word overlap replaces the earlier lesson (`supersedes`, old one retired) and accumulates its evidence. `retireLesson` / `supersedeLesson` do the same by hand.
