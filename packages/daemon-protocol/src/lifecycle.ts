...
import type { DaemonFeature, HarnessPhase, SessionClosedCode, UpdatePhase } from '@agentic/core';
...
export const DAEMON_FEATURES = ['update', 'harness'] as const satisfies readonly DaemonFeature[];
...
const covered: [Covers<SessionClosedCode, typeof SESSION_CLOSED_CODES>, Covers<DaemonFeature, typeof DAEMON_FEATURES>, Covers<UpdatePhase, typeof UPDATE_PHASES>, Covers<HarnessPhase, typeof HARNESS_PHASES>] = [true, true, true, true];
void covered;
