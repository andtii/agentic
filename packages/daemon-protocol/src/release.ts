 ...
 * newer. A build off `main` (`0.2.0-main.<commit unix seconds>.<sha7>`, `g<sha7>` for a digits-only sha7 with a leading zero; #437) is a prerelease, so it orders below `0.2.0`
