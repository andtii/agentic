...
export const NOTIFICATION_KINDS = ['reminder', 'task-done', 'task-failed', 'approval', 'input', 'update-available', 'update-applied', 'update-failed', 'daemon-crash-loop', 'harness-update-available'] as const;
