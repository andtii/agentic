...
describe('contract type tests', () => {
    it('task status and wait reasons are closed unions', () => {
        ...
        expectTypeOf<Discriminant<WaitReason, 'kind'>>().toEqualTypeOf<'approval' | 'input' | 'environment-offline' | 'child' | 'capacity' | 'budget' | 'project-feature' | 'turn' | 'machine-offline' | 'pull-request'>();
    ...
    it('fs operations and results are closed unions', () => {
        expectTypeOf<Discriminant<FsOp, 'kind'>>().toEqualTypeOf<'list' | 'worktree' | 'locate' | 'tree' | 'read' | 'changes' | 'run' | 'worktrees' | 'worktree-remove' | 'pin' | 'read-at'>();
        expectTypeOf<Discriminant<FsResult, 'kind'>>().toEqualTypeOf<'list' | 'worktree' | 'locate' | 'tree' | 'read' | 'changes' | 'run' | 'worktrees' | 'worktree-remove' | 'pin' | 'read-at'>();
