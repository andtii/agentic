...
export {
    ...
    type MachineUpdatedData,
    type MachineUpdateFailedData,
    type MachineChannelSetData,
    type MachineUpdatePolicySetData,
    type PluginActivatedData,
    type PluginGrantedData,
    type PluginRevokedData,
    type PluginToggledData,
    type PluginToolPolicyData,
