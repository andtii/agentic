...
| Revoking a session grant | session grants are listed, not revocable — they end with the session (`SessionInfo.grants`; the adapter keeps its grants private); the session page draws no Revoke | — (#154) |
