# Contributing to SignalX agentic
...
```bash
git clone https://github.com/andtii/agentic.git agentic/main
cd agentic/main
pnpm install
pnpm build
```
...
- **No `CHANGELOG.md` entries.** Describe user-visible changes in the PR title and body; release notes are drafted from PR titles. The existing `CHANGELOG.md` files are frozen history.
...
- **Bug?** Open an issue with the [bug report template](https://github.com/andtii/agentic/issues/new?template=bug_report.yml). A minimal reproduction helps a lot.
- **Feature idea?** Use the [feature request template](https://github.com/andtii/agentic/issues/new?template=feature_request.yml).
